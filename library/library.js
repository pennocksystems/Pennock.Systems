const headerText = "Welcome to the Pennock Systems Demo Library";
const subText = "Select a bot to explore firsthand how our chatbots work across different industries, so you can envision what’s possible for your business.";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function drawMatrix() {
    ...
    gradient.addColorStop(0, '#ff8ce6');
    gradient.addColorStop(1, '#00f9ff'); 
